...
const en = {
  ...
  quoteThankYou: {
    ...
    preparingStatus: "Securing your request to your account…",
    signupRedirectStatus: "One quick step keeps this request connected to you.",
    clientRedirectStatus: "Your request is saved to your Beaumont account.",
    continueToSignup: "Create my account",
    continueToPanel: "Continue to my quotes",
    redirectCountdown: "Continuing automatically in {seconds} seconds…",
    resumeMissing: "We could not find the pending request on this device. Please return to the quote and try again.",
    resumeExpired: "This pending request has expired. Please return to the quote to refresh it.",
    resumeError: "We could not finish saving your request. Please try again.",
    returnToQuote: "Return to the quote",
...
const fr: Dictionary = {
  ...
  quoteThankYou: {
    ...
    preparingStatus: "Nous associons votre demande à votre compte…",
    signupRedirectStatus: "Une dernière étape permet de relier cette demande à votre compte.",
    clientRedirectStatus: "Votre demande est enregistrée dans votre compte Beaumont.",
    continueToSignup: "Créer mon compte",
    continueToPanel: "Voir mes soumissions",
    redirectCountdown: "Redirection automatique dans {seconds} secondes…",
    resumeMissing: "Nous n’avons pas trouvé la demande en attente sur cet appareil. Revenez à la soumission et réessayez.",
    resumeExpired: "Cette demande en attente a expiré. Revenez à la soumission pour la recommencer.",
    resumeError: "Nous n’avons pas pu enregistrer votre demande. Veuillez réessayer.",
    returnToQuote: "Retour à la soumission",
