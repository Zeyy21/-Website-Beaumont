...
const en = {
  ...
  hero: {
    ...
    titleA: "Come home to",
    titleB: "nothing left to do.",
    body: "Driveways, decks, home exteriors, and windows—considered together, meticulously cared for, and one less thing asking for your time.",
    ctaPrimary: "Begin your estimate",
  ...
  principles: {
    ...
    b: {
      ...
      copy: "Clear timing, careful preparation, no theatre.",
    },
    c: {
  ...
  servicesSection: {
    ...
    titleB: "One considered standard.",
    service: "Service",
    details: {
  ...
  footer: {
    beginEstimate: "Begin your estimate",
    explore: "Explore",
    contact: "Contact",
...
const fr: Dictionary = {
  ...
  services: {
    driveway: {
      ...
      description:
        "Béton, pavé uni, asphalte, marches et allées avant nettoyés pour une arrivée plus lumineuse.",
    },
    deck: {
      name: "Lavage de terrasses et patios",
      description:
        "Bois, composite, béton et espaces de vie extérieurs rafraîchis avec une pression adaptée au matériau.",
    },
    "house-wash": {
      name: "Lavage en douceur de la maison",
      description:
        "Lavage extérieur à basse pression pour le revêtement, la brique, le stuc, les détails peints et les finis délicats.",
    },
    "windows-atlantic": {
      name: "Lavage de fenêtres extérieures",
      description:
        "Vitres, cadres et rebords extérieurs nettoyés à l’eau purifiée pour un fini clair, sans traces.",
    },
  },
  ...
  principles: {
    ...
    b: {
      ...
      copy: "Un calendrier clair, une préparation soignée, sans flafla.",
    },
    c: {
  ...
  servicesSection: {
    eyebrow: "Services",
    intro:
      "Lavage à pression, lavage en douceur et entretien spécialisé des fenêtres, choisis pour chaque surface, chaque cadre et chaque maison montréalaise.",
    titleA: "Chaque surface extérieure.",
    titleB: "Une norme réfléchie.",
    service: "Service",
    details: {
  ...
  approach: {
    ...
    intro:
      "Beaumont, c’est la restauration extérieure sans bruit, sans approximation ni flafla inutile. Chaque visite est pensée de l’arrivée à l’inspection finale.",
    ...
    chapters: {
      arrival: {
        eyebrow: "L’arrivée",
        title: "Préparés autour de votre propriété.",
        copy: "Nous arrivons avec le bon traitement, protégeons l’aménagement environnant et établissons une portée claire avant que l’eau ne touche la pierre.",
      },
      work: {
        eyebrow: "Le travail",
        title: "La pression, appliquée avec précision.",
        copy: "Béton, pavés, pierre naturelle et revêtement reçoivent chacun une méthode choisie pour le matériau — pas un réglage unique pour tout.",
      },
      return: {
        eyebrow: "Le résultat",
        title: "Il ne reste que le résultat.",
        copy: "Les bordures sont finies, le ruissellement est maîtrisé, et la propriété est rendue plus lumineuse, ordonnée et prête à apprécier.",
      },
    },
  },
  ...
  testimonialSection: {
    ...
    quote:
      "Ça a rendu toute la maison comme neuve. La propriété semblait de nouveau entretenue.",
