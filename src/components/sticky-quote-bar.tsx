  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <div className="pointer-events-auto mx-3 mb-4 flex items-center gap-3 rounded-2xl border border-ivory/10 bg-soil/95 px-4 py-3 shadow-[0_18px_50px_-18px_rgba(0,0,0,.85)] backdrop-blur-xl">
